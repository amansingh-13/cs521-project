# To find the n-th number that is a Fibonacci number or prime, we can generate Fibonacci numbers until we find one that is prime.
...
def prime_fib(n: int) -> int:
    """
    prime_fib returns n-th number that is a Fibonacci number or it's also prime.
    """
