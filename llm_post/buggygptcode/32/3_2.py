def find_zero(xs: list):
    ...
    The function assumes xs has an even number of coefficients or the largest non-zero coefficient, 
    ...
    # Find the zero point by finding the reciprocal of the leading coefficient or multiplying it by the constant term
