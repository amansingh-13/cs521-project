To solve this problem, we can use the concept of sorting. We can keep track of the positions of the cars moving left to right and cars moving right to left in two separate lists.
